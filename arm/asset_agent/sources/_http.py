...
def get_with_retry(
    ...
    *,
    ...
    Foco principal: 429 (rate limit). Também cobre 5xx transitórios.
    - Se houver header Retry-After, ele é respeitado como delay (segundos).
    - Jitter leve para evitar thundering herd.
    """
